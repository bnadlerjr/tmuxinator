...
module Tmuxinator
  class Cli < Thor
    ...
    COMMANDS = {
      ...
      pause: "Pause a tmux session using a project's tmuxinator config",
      resume: "Resume a tmux session using a project's tmuxinator config",
    ...
    no_commands do
      ...
      def pause_project(project)
        Kernel.exec(project.pause)
      end

      def resume_project(project)
        Kernel.exec(project.resume)
      end
    ...
    desc "pause [PROJECT]", COMMANDS[:pause]
    map "pa" => :pause
    method_option "suppress-tmux-version-warning",
                  desc: "Don't show a warning for unsupported tmux versions"
    ...
    desc "resume [PROJECT]", COMMANDS[:resume]
    map "rs" => :resume
    method_option "suppress-tmux-version-warning",
                  desc: "Don't show a warning for unsupported tmux versions"
